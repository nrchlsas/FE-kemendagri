...
const BarWithPercentageModifiedStunting = ({dataColors, valueChart=[], percentageChart1=[], percentageChart2=[], categoryChart=[], additionalData=[], axisY=[], seProv=false, kabupaten=false, dataTotal=10}) => {
...
// Tentukan `startIndex` dan `endIndex` berdasarkan limit
    ...
    var option = {
        ...
        series: [            
            {
                name: seProv ? 'Anggaran Stunting se-Provinsi' : kabupaten ? 'Anggaran Stunting Kabupaten/Kota' : 'Anggaran Stunting Provinsi' ,
                type: 'line',
                data: valueChart,
                itemStyle: {
                    color: '#FCAD24'
            ...
            {
                name: seProv ? 'Persentase Anggaran Stunting se-Provinsi' : kabupaten ? 'Persentase Anggaran Stunting Kabupaten/Kota' : 'Persentase Anggaran Stunting Provinsi', 
                type: 'bar',
...
export default BarWithPercentageModifiedStunting;