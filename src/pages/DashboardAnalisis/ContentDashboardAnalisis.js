    ...
    <React.Fragment>
        <Row>
            <Col>
                ...
                <div className="d-flex flex-column title-page" style={{padding:"0 0 13px 0"}}>                
                    <div className="d-flex justify-content-start ms-2 align-items-center">
                        <span>Dashboard Analisis</span>    
                    </div>
                    <div className="d-flex justify-content-start ms-2 align-items-center" style={{color: "#CCD4DC", fontSize:"16px", fontWeight:"400"}}>
                        <span>Terakhir diperbarui: Sabtu, 14 September 2024, Pukul 12:30</span>
                    </div>
                </div>
                </div>
                <Row>
                        ...
                        <Card>        
                            ...
                            <CardBody>
                                <div className="d-flex justify-content-between align-items-start">
                                    ...
                                    <div className="d-flex flex-column align-items-end" style={{fontSize:"18px"}}>
                                        <span className="mb-2">21312</span>
                                        <span className="mb-2">12321</span>
                                        <span className="mb-2">1231</span>
                                        <span className="mb-2">123123123</span>
                                        <span className="mb-2">1232131</span>
                                        <span className="mb-2">13125</span>
                                        <span className="mb-2">1232131</span>
                                        <span className="mb-2">13125</span>
                                    </div>
                                </div>                   
                                ...
                                <Card>
                                    <CardBody>
                                        <div className="d-flex flex-column title-custom-card">
                                            ...
                                            <span>Total Anggaran Standar Pelayanan Minimal (SPM)</span>
                                            </div>
                            ...
                            <tr key={index}>
                                <td>
                                    <div className="d-flex align-items-center mb-2">
                                        ...
                                        <span style={{fontStyle:"poppins", color:"#929FB1"}}>belanja</span>
                                    </div>
                                </td>
                                <td>Rp {Math.floor(Math.random()*10000000000)}</td>
                                <td><span style={{ float: "right" }}>{`${Math.floor(Math.random()*100)}%`}</span></td>                    
                            </tr>
                            ))}
                            <tr >
                                <td className="border-bottom-0">Total</td>
                                <td className="border-bottom-0" style={{fontWeight:600}}>Rp {Math.floor(Math.random()*10000000000000)}</td>
                            </tr>
                        </tbody>
                    </table>                                
                    </CardBody>
        ...
        <Row>
            <Col>
                <Card>
                    ...
                    <CardBody>
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis adipisci eaque doloremque incidunt, excepturi 
                        doloribus cupiditate? Harum minus asperiores aspernatur, quo laudantium beatae sit vel unde cumque eius neque soluta, 
                        est ullam dignissimos fugit corporis, dolorem aut. Excepturi sequi aut dolorum obcaecati doloremque porro, nulla deserunt 
                        sint rem dolorem earum suscipit, voluptatum nam atque incidunt perspiciatis reprehenderit id possimus nesciunt explicabo 
                        illum? Sapiente neque quidem vero quibusdam molestias ratione maiores eius enim, recusandae voluptates ut inventore dicta placeat 
                        ipsa, eligendi repellat incidunt modi. Distinctio tempora tenetur pariatur! Iure tempore nulla, ratione accusamus sint quod sapiente 
                        aspernatur sed. Officia, rem earum!
                    </CardBody>
                </Card>
            </Col>
        </Row>
                    ...
                    <table class="table table-nowrap">    
                        <tbody>
                            ...
                            <tr key={index}>
                                ...
                                <td>
                                    <div className="d-flex align-items-center mb-2">
                                        <div className="d-flex flex-column justify-content-evenly">
                                            <div className="d-flex align-items-center mb-2">
                                                <div style={{ height: "10px", width: "10px", backgroundColor: "#57E7B4", marginRight: "8px" }}></div>
                                                <span style={{fontStyle:"poppins", color:"#929FB1"}}>Pendapatan</span>
                                            </div>                
                                            <div className="d-flex align-items-center mb-2">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <span style={{fontStyle:"poppins", color:"#929FB1"}}>Pembiayaan</span>
                                            </div>
                                        </div>                                    
                                    </div>
                                </td>
                                ...
                                <div className="d-flex flex-column justify-content-evenly">
                                        <div className="d-flex align-items-center mb-2">                                            
                                            <span style={{fontStyle:"poppins", color:"#929FB1"}}>{`Rp ${Math.floor(Math.random()*10000000000)}`}</span>
                                        </div>                
                                        <div className="d-flex align-items-center mb-2">                                            
                                            <span style={{fontStyle:"poppins", color:"#929FB1"}}>{`Rp ${Math.floor(Math.random()*10000000000)}`}</span>
                                        </div>                    
                                ...
                                <td>                                
                                    <div className="d-flex flex-column justify-content-evenly">
                                        <div className="d-flex align-items-center mb-2">                                            
                                            <span style={{fontStyle:"poppins", color:"#929FB1"}}>10%</span>
                                        </div>                
                                        <div className="d-flex align-items-center mb-2">                                            
                                            <span style={{fontStyle:"poppins", color:"#929FB1"}}>10%</span>
                                        </div>                    
                                        <div className="d-flex align-items-center">                                            
                                            <span style={{fontStyle:"poppins", color:"#9f9FB1"}}>10%</span>
                                        </div>
                                    </div>                                                                    
                                </td>
                            </tr>
