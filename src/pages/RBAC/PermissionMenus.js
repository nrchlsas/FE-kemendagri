...
const PermissionMenus = () => {
    ...
    async function populate_data() {
        ...
        let response = api.create(`${API_9007_URI}/rbac/list-permission-menu-table`, json);
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            if (is_edit) {
                ...
                response = api.put(`${API_9007_URI}/rbac/update-permission-menu`, edit_json);
            } else {
                const json = JSON.parse(JSON.stringify(formData));
                response = api.create(`${API_9007_URI}/rbac/create-permission-menu`, json);
            }
